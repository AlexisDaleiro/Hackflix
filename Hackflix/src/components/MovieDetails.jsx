...
export default function MovieDetails() {
  ...
  const obtenerSinopsis = () => {
    return reseñasPersonalizadas[id] || peliculas?.overview || "Sinopsis no disponible";
  };
  ...
  return (
    <div className="container-fluid text-white py-4 pt-0 position-relative"
     style={{ minHeight: '100vh', zIndex: 1 }}>

    
      <div style={peliculas?.backdrop_path ? backgroundStyle : fallbackStyle}></div>

      <Navbar />

      <div className="container-fluid text-white ms-1 py-4 pb-3 row position-relative"
      style={{
          ...
          <>
            ...
            <div className="col-md-8 d-flex flex-column justify-content-between">
              <h2 style={{
                ...
                background: 'linear-gradient(135deg,rgb(185, 53, 53),rgb(143, 120, 27))',
                ...
                {actores.length > 0 && (
                  <p style={{ 
                    ...
                    <span style={{ 
                      ...
                      Actores:
                    </span> {actores.map((actor) => actor.name).join(", ")}
                  </p>
                )}

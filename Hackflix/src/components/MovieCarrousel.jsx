...
<div className="d-flex justify-content-center">
  ...
  >
      ...
      >
        {peliculas.map((item) => (
          <div  key={item.id} className="card-container me-3 " style={{textAlign: "center" }}>
            <div>
            <img
            ...
            />
            <div className="info-overlay p-2 justify-content-center" style={{width: "100%"}}>
            <h5 className="text-white mt-2 justify-content-center">{item.title}</h5>
